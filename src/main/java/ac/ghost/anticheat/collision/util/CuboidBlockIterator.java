package ac.ghost.anticheat.collision.util;
...
public class CuboidBlockIterator {
	...
	public static CuboidBlockIterator iterator(final Box box) {
		int i = NukkitMath.floorDouble(box.minX - 1.0E-7) - 1;
		int j = NukkitMath.floorDouble(box.maxX + 1.0E-7) + 1;
		int k = NukkitMath.floorDouble(box.minY - 1.0E-7) - 1;
		int l = NukkitMath.floorDouble(box.maxY + 1.0E-7) + 1;
		int m = NukkitMath.floorDouble(box.minZ - 1.0E-7) - 1;
		int n = NukkitMath.floorDouble(box.maxZ + 1.0E-7) + 1;
